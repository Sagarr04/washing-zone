<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li><a href="add-booking.php"><i class="fa fa-user" aria-hidden="true"></i> <span>Wash Booking</span>
					<div class="clearfix"></div>
				</a></li>


			<li id="menu-academico"><a href="#"><i class="fa fa-files-o" aria-hidden="true"></i><span>Bookings</span>
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Pages</span> <span
