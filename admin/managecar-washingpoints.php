...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		<title>WZ | Manage Wash Point</title>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) { ?>
											<tr>
												...
												<td>
													<a
														href="editcar-washpoint.php?wpid=<?php echo htmlentities($result->id); ?>">Edit</a>
													| <a href="managecar-washingpoints.php?rid=<?php echo htmlentities($result->id); ?>"
														style="color:red;"
