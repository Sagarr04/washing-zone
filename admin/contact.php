...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		<title>WZ | Contact Us info</title>
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Contact us
						information</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
								...
								<div class="tab-pane active" id="horizontal-form">
									<form class="form-horizontal" name="washingpoint" method="post"
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<textarea class="form-control" name="address" id="address" placeholder="Address"
													required rows="4"><?php echo $result->detail; ?></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" name="openinghrs" id="openinghrs"
													placeholder="Opening Hour" value="<?php echo $result->openignHrs; ?>"
													required>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="email" class="form-control" name="emailid" id="emailid"
													placeholder="Email Id" required value="<?php echo $result->emailId; ?>">
											</div>
										</div>
