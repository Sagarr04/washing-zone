...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		echo "<script>alert('washing point updated successfully');</script>";
	...
	<head>
		<title>WZ | Edit Washing Point</title>
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Edit
						Washing Point </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
								...
								<div class="tab-pane active" id="horizontal-form">
									<form class="form-horizontal" name="washingpoint" method="post"
										...
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">Wash Point Name</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" name="washingpointname"
													id="washingpointname"
													value="<?php echo htmlentities($result->washingPointName); ?>" required>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												<textarea class="form-control" name="address" id="address" placeholder="Address"
													required
													rows="4"><?php echo htmlentities($result->washingPointAddress); ?></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" name="contactno" id="contactno"
													value="<?php echo htmlentities($result->contactNumber); ?>" required>
											</div>
										</div>
