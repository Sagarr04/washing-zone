	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage New
						Bookings</li>
				</ol>
										...
										foreach ($results as $result) { ?>
											...
											<tr>
												...
												<td>
													...
													if ($ptype == 1):
														echo "BASIC CLEANING (INR 100/-)";
													endif;
													if ($ptype == 2):
														echo "SILVER CLEANING (INR 300/-)";
													endif;
													if ($ptype == 3):
														echo "PREMIUM CLEANING (INR 500/-)";
													endif;
											...
											<tr>
												<th>Washing Date</th>
												<td>
													<?php echo htmlentities($result->washDate); ?>
												</td>
												<th>Washing Time</th>
												<td>
													<?php echo htmlentities($result->washTime); ?>
												</td>
											</tr>
											<tr>
											...
											<?php else: ?>
												...
												<tr>
													...
													<td>
														<?php echo htmlentities($result->paymentMode); ?>
													</td>
													<th>Transaction No.(if any)</th>
													<td>
														<?php echo htmlentities($result->txnNumber); ?>
													</td>
												</tr>
												<tr>
													<th>Admin Remark</th>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<form method="post">
										...
										<p><input type="text" name="transactionno" class="form-control"
