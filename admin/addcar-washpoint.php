...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($lastInsertId) {
			echo "<script>alert('washing point added successfully');</script>";
	...
	<head>
		<title>WZ | Add Washing Point</title>
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Add Washing
						Point </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" name="washingpointname"
												id="washingpointname" placeholder="Washing Point Name" required>
										</div>
									</div>
									<div class="form-group">
