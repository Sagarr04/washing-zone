...
<head>
    <meta charset="utf-8">
    <title>Washing Zone | Home Page</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="section-header text-left">
                        <p>About Us</p>
                        <h2>Best washing and detailing</h2>
                    </div>
                    <div class="about-content">
                        <p>
                            washing zone is a brand which is literally going to change the way people think about
                            vehicle cleaning. It is a unique mechanized cleaning concept where vehicles are getting
                            pampered by the latest equipment including high pressure cleaning machines, spray injection
                            and extraction machines, high powered vacuum cleaners, steam cleaners and so on.
                        </p>
                        <ul>
                ...
                <div class="col-md-4">
                    <div class="price-item">
                        <div class="price-header">
                            ...
                            <h2><span>₹</span><strong>100</strong><span>/-</span></h2>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="price-item featured-item">
                        <div class="price-header">
                            ...
                            <h2><span>₹</span><strong>300</strong><span>/-</span></h2>
                        </div>
                        <div class="price-body">
                            <ul>
                                <li><i class="far fa-check-circle"></i>Seats Washing</li>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Washing Booking</h4>
                </div>
                    ...
                    <form method="post">
                        <p>
                            <select name="packagetype" required class="form-control">
                                ...
                                <option value="1">BASIC CLEANING (INR 100/-)</option>
                                <option value="2">SILVER CLEANING (INR 300/-)</option>
                                <option value="3 ">PREMIUM CLEANING (INR 500/-)</option>
                            </select>
                        ...
                        <p><input type="text" name="contactno" class="form-control" pattern="[0-9]{10}"
                                title="10 numeric characters only" required placeholder="Mobile No."></p>
